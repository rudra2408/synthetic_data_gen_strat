# synthetic_data_gen_strat
This project lies at the perfect intersection of software and ML. How different strategies of data generation can affect accuracy, latency and compute of our system.
This project focuses on building and evaluating GAN-based models for generating synthetic data in both **tabular** and **image domains**.
